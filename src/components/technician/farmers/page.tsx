    ...
    return (
      <div className="text-center py-10 bg-card rounded-lg shadow">
        ...
        <p className="text-muted-foreground mt-2">
          Não foram encontrados agricultores {assignedMunicipalities.length > 0 ? `para suas unidades atribuídas: ${assignedMunicipalities.join(', ')}.` : 'no sistema.'}
        </p>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {assignedMunicipalities.length > 0
                ? `Visíveis para suas unidades: ${assignedMunicipalities.join(', ')}`
