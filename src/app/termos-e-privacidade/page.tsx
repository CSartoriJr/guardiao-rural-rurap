      ...
      <Card className="w-full max-w-3xl shadow-xl">
        ...
        <CardContent className="space-y-6 text-sm text-foreground">
          ...
          <section>
            ...
            <p>Ao enviar um pedido de análise, o Aplicativo solicitará acesso à sua localização GPS. Se concedido, as coordenadas de latitude e longitude serão coletadas e associadas ao seu pedido. A IA também poderá tentar extrair informações de localização das fotos enviadas se o GPS do dispositivo não estiver disponível ou não for fornecido. Essas informações são usadas para determinar o município e podem auxiliar no diagnóstico e nas recomendações agronômicas.</p>
          </section>
