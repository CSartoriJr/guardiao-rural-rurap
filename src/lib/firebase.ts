...
// Verifique se as variáveis de ambiente essenciais estão presentes
if (!firebaseConfig.apiKey || !firebaseConfig.projectId) {
  console.error('[Firebase Initialization Error] As variáveis de ambiente do Firebase (NEXT_PUBLIC_FIREBASE_API_KEY, etc.) não estão definidas no arquivo .env. O aplicativo não pode ser inicializado.');
} else {
  try {
