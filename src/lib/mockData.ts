...
export let mockUsers: User[] = [
  { id: 'farmer1', cpf: '111.111.111-11', role: 'farmer', name: 'João Agricultor' },
  { id: 'tech1', cpf: '222.222.222-22', role: 'technician', name: 'Alice Técnica' },
  { id: 'farmer2', cpf: '333.333.333-33', role: 'farmer', name: 'Maria Garcia' },
  { id: 'farmer3', cpf: '444.444.444-44', role: 'farmer', name: 'Chen Wei' },
  { id: 'tech2', cpf: '555.555.555-55', role: 'technician', name: 'David Moleiro' },
  { id: 'tech3', cpf: '666.666.666-66', role: 'technician', name: 'Fátima Khan' },
  { id: 'farmer4', cpf: '777.777.777-77', role: 'farmer', name: 'Bento Agricultor' },
  { id: 'tech4', cpf: '888.888.888-88', role: 'technician', name: 'Clara Artesã' },
  { id: 'farmer5', cpf: '999.999.999-99', role: 'farmer', name: 'Kenji Tanaka' },
  { id: 'tech5', cpf: '000.000.000-01', role: 'technician', name: 'Isabelle Moreau' },
  { id: 'farmer6', cpf: '000.000.000-02', role: 'farmer', name: 'Pedro Alvares' },
  { id: 'farmer7', cpf: '000.000.000-03', role: 'farmer', name: 'Sofia Costa' },
  { id: 'tech6', cpf: '000.000.000-04', role: 'technician', name: 'Ricardo Neves' },
  { id: 'tech7', cpf: '000.000.000-05', role: 'technician', name: 'Lúcia Ferreira' },
  { id: 'admin1', cpf: '000.000.000-00', role: 'admin', name: 'Admin Mestre' },
  { id: 'farmer8', cpf: '000.000.000-06', role: 'farmer', name: 'Carlos Silva' },
  { id: 'farmer9', cpf: '000.000.000-07', role: 'farmer', name: 'Ana Pereira' },
  { id: 'tech8', cpf: '000.000.000-08', role: 'technician', name: 'Roberto Dias' },
  { id: 'tech9', cpf: '000.000.000-09', role: 'technician', name: 'Juliana Andrade' },
  { id: 'farmer10', cpf: '101.010.101-01', role: 'farmer', name: 'Lucas Mendes' },
